...
public class OuterClass2 {
	...
	public Object someOp() {
		final strictfp class MethodLocalClass { // ka¿da klasa jest podklas¹
												// klasy Object
			public String toString() { // These classes can be : abstract, final
										// or strictfp.
				// not public, private or protected.
				return "Instancja klasy MethodLocalClass!";
			}
		}
		// zwracamy instancjê klasy MethodLocalClass
		...
		// defined.
		// but we can return an instance of this class and assign it to some not
		// local supertype.
}
