...
class Child extends Override1 {
	void test() throws IOException, SQLException { // both are subtypes of
		// Exception exception.
		try { // Had to use try catch block because of
			// unhandled Exception exception
			super.test(); // Calling overridden method.
		} catch (Exception e) {
...
// #1 - specificator can be the same r less restricting.
...
// thosedeclared in overridden method.
